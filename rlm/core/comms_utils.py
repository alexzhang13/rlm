...
def socket_request(address: tuple[str, int], data: dict, timeout: int = 660) -> dict:
    ...
    Args:
        ...
        timeout: Socket timeout in seconds (default 660).
...
def send_lm_request(
    address: tuple[str, int], request: LMRequest, timeout: int = 660, depth: int | None = None
) -> LMResponse:
