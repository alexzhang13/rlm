...
#### InstaVM <img src="https://instavm.io/favicon.ico" alt="InstaVM" height="20" style="vertical-align: middle;"/>
To use [InstaVM](https://instavm.io) (Firecracker microVMs with sub-second cold starts) as the REPL environment, install the SDK and set your API key:
```bash
uv pip install -e ".[instavm]"
