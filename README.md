...
```
Trace notebooks include `llm_query` replay from recorded subcalls. Prompts must match exactly. **[View Trace Log Example](docs/examples/trace-log-example.md)** | **[Source Notebook](docs/examples/trace-log-example.ipynb)** | **[Raw JSONL](docs/examples/trace-log-example.jsonl)**
...
**[View Full Jupyter Integration Tutorial](docs/examples/notebook-integration.md)** | **[Source Notebook](docs/examples/notebook-integration.ipynb)**
